...
public class UpdateBasicInformationCommandHandler : IRequestHandler<UpdateBasicInformationCommand,UpdateBasicInformationResponse>
{
    ...
    public async Task<UpdateBasicInformationResponse> Handle(
        UpdateBasicInformationCommand request,
        CancellationToken cancellationToken)
    {
        ...
        studentProfile.ChangeBasicInformation(request.fullName, request.bio);
        await _unitOfWork.SaveChangesAsync(cancellationToken);

        return new UpdateBasicInformationResponse
        {
            Message = "Success"
        };
    }
