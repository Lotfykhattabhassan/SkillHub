...
{
    /// <inheritdoc />
    public partial class InitialStudentProfile : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileImageUrl = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentSocialLinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentSocialLinks_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentLanguages_StudentProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentSocialLinks_StudentProfileId",
                table: "StudentSocialLinks",
                column: "StudentProfileId");
        }
